...
public:
    ...
    int addIndex(string indexName,string tableName,string attributeName,int type,char* addressBegin);
    ...
    void recordStringGet(string tableName, vector<string>* recordContent, char* recordResult, vector<Attribute>* attributeVector);
};
