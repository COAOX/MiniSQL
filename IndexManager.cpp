...
IndexManager::~IndexManager()
{
    ...
    for(stringMap::iterator itString = indexStringMap.begin();itString != indexStringMap.end(); itString ++)
    {
        if(itString->second)
        {
            itString ->second-> writeBackToDisk();
    ...
    for(floatMap::iterator itFloat = indexFloatMap.begin();itFloat != indexFloatMap.end(); itFloat ++)
    {
        if(itFloat->second)
        {
            itFloat ->second-> writeBackToDisk();
...
void IndexManager::dropIndex(string filePath,int type)
{
    if(type == TYPE_INT)
    {
        ...
        {
            cout << "Error4:in drop index, no index " << filePath <<" exits" << endl;
            return;
        }
        else
        {
    ...
    else if(type == TYPE_FLOAT)
    {
        ...
        {
            cout << "Error5:in drop index, no index " << filePath <<" exits" << endl;
            return;
        }
        else
        {
    ...
    else // string
    {
        ...
        {
            cout << "Error6:in drop index, no index " << filePath <<" exits" << endl;
            return;
        }
        else
        {
...
offsetNumber IndexManager::searchIndex(string filePath,string key,int type)
{
    ...
    if(type == TYPE_INT)
    {
        ...
        if(itInt == indexIntMap.end())
        {
            cout << "Error7:in search index, no index " << filePath <<" exits" << endl;
            return -1;
        }
        else
        {
    ...
    else if(type == TYPE_FLOAT)
    {
        ...
        if(itFloat == indexFloatMap.end())
        {
            cout << "Error8:in search index, no index " << filePath <<" exits" << endl;
            return -1;
        }
        else
        {
    ...
    else // string
    {
        ...
        if(itString == indexStringMap.end())
        {
            cout << "Error9:in search index, no index " << filePath <<" exits" << endl;
            return -1;
        }
        else
        {
...
void IndexManager::insertIndex(string filePath,string key,offsetNumber blockOffset,int type)
{
    ...
    if(type == TYPE_INT)
    {
        ...
        if(itInt == indexIntMap.end())
        {
            cout << "Error10:in search index, no index " << filePath <<" exits" << endl;
            return;
        }
        else
        {
    ...
    else if(type == TYPE_FLOAT)
    {
        ...
        if(itFloat == indexFloatMap.end())
        {
            cout << "Error11:in search index, no index " << filePath <<" exits" << endl;
            return;
        }
        else
        {
    ...
    else // string
    {
        ...
        if(itString == indexStringMap.end())
        {
            cout << "Error12:in search index, no index " << filePath <<" exits" << endl;
            return;
        }
        else
        {
...
void IndexManager::deleteIndexByKey(string filePath,string key,int type)
{
    ...
    if(type == TYPE_INT)
    {
        ...
        if(itInt == indexIntMap.end())
        {
            cout << "Error1:in search index, no index " << filePath <<" exits" << endl;
            return;
        }
        else
        {
    ...
    else if(type == TYPE_FLOAT)
    {
        ...
        if(itFloat == indexFloatMap.end())
        {
            cout << "Error2:in search index, no index " << filePath <<" exits" << endl;
            return;
        }
        else
        {
    ...
    else // string
    {
        ...
        if(itString == indexStringMap.end())
        {
            cout << "Error3:in search index, no index " << filePath <<" exits" << endl;
            return;
        }
        else
        {
